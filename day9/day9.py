...
def usage():
    ...
    print("Find how many positions the tail of the rope visits.\n")
...
def main(input_file_name):
    ...
    for line in lines:
        ...
        for i in range(int(instr[1])):
            currHead = currHead.shiftedBy(x_diff, y_diff)
            currTail = findTailPosFrom(currHead, currTail)
            positions_visited.add(currTail)
